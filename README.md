...
The screenshots demonstrate the functionality of all implemented endpoints:

### Basic Endpoints
- Home Endpoint  
- Get All Movies  
- Get Movie by ID (Valid / Invalid)  
- Get All Bookings  
- Movies Summary  

### Validation and Helpers
- Booking Validation Error (Pydantic)  
- Helper Functions Implementation  

### Booking and Filtering
- Create Booking and Seat Update  
- Booking with Promo Code  
- Filter Movies  

### CRUD Operations
- Add Movie (Success / Duplicate)  
- Update Movie (Valid / Invalid)  
- Delete Movie (Blocked / Success / Not Found)  

### Seat Hold Workflow
- Create and View Seat Hold  
- Confirm and Release Seat Hold  

### Search, Sort, Pagination
- Movie Search (Found / Not Found)  
- Sorting (Valid / Invalid Cases)  
- Pagination (Multiple Pages)  
- Booking Search, Sort, and Pagination  
...
- Structuring backend systems for clarity and scalability  
